...
def _candidate_models(n_samples: int) -> dict:
    models = {
        "RandomForest": RandomForestRegressor(n_estimators=300, random_state=42, min_samples_leaf=1),
        "GradientBoosting": GradientBoostingRegressor(n_estimators=200, random_state=42, max_depth=3),
    ...
    if _HAS_XGB and n_samples >= 8:
        models["XGBoost"] = XGBRegressor(
            n_estimators=200, max_depth=3, learning_rate=0.08, random_state=42, verbosity=0
        )
    return models
